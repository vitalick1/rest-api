Feature:
  ...
  Scenario: Create user
    ...
    And response should contain header 'Location' with value matching '/^\/rest\/user\/\d+$/'
  ...
  Scenario: Update user
    ...
    And request body:
      """
      {"username":"vitalick","first_name":"Vitalie","last_name":"Lisnic1","email":"lisnicvitalie@yahoo.com"}
      """
    ...
    And Json response should have param 'username' equal to 'vitalick'
    And Json response should have param 'first_name' equal to 'Vitalie'
    And Json response should have param 'last_name' equal to 'Lisnic1'
    And Json response should have param 'email' equal to 'lisnicvitalie@yahoo.com'
